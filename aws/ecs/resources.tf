...
module "ecs" {
  ...
  alb_subnet_ids = data.terraform_remote_state.vpc.outputs.public_subnet_ids
  ...
  alb_log_bucket_arn = data.terraform_remote_state.s3.outputs.alb_log_bucket_arn
  alb_log_bucket_id = data.terraform_remote_state.s3.outputs.alb_log_bucket_id
  ...
  ecs_service_subnets = data.terraform_remote_state.vpc.outputs.private_subnet_ids
